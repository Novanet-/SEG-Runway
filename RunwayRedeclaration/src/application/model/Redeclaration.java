...
public class Redeclaration
{
	...
	public static Runway redeclareParameters(Runway runway)
	{
		...
		//		double newTORA =
		//				runwayParameters.getTORA() - obstacle.getBlastProtection() - ((Obstacle) obstacle).getDistanceFromThreshold() - runwayParameters.getDisplacedThreshold();
		//		double newTODA = newTORA + STOPWAY;
		//		double newASDA = newTORA + CLEARWAY;
		//		double newLDA = runwayParameters.getLDA() - obstacle.getDistanceFromThreshold() - stripEnd() - slopeCalculation();

		//if takeOffTowards() and landingTowards()
		//		double newTORA = obstacle.getDistanceFromThreshold() - slopeCalculation() - stripEnd();
		//		double newTODA = newTORA;
		//		double newASDA = newTORA;
		//		double newLDA = obstacle.getDistanceFromThreshold() - obstacle.getRESA - stripEnd();
